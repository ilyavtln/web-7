									...
									if (isset($_COOKIE['user']) && $_COOKIE['user'] != ''): ?>
                                        ...
                                        <li>
                                            <span class="dropdown-item" href="../auth/cabinet.php"><span
                                                        class="pe-1"><?= $userPoints ?></span><i class="bi bi-coin purple-color"></i></span>
                                        </li>
                    ...
                    <div class="banner-flying row g-0 border rounded">
                        <div class="p-4 d-flex flex-column justify-content-between">
                            <div class="text-center">
                                ...
                                <p class="card-text mb-3 text-center"><?= $oneGift["price"] ?><i class="ml-1 bi bi-coin purple-color"></i></p>
	                            <?php
	                            if (isset($_SESSION['admin_access']) && $_SESSION['admin_access'] == true): ?>
                                    <a class="btn btn-outline-danger mb-3 w-100" href="../scripts/php/deleteFromCatalog.php?id=<?= $oneGift["id"] ?> ?>" role="button">Удалить товар</a>
	                            <?php endif; ?>
							    <?php
								    if (isset($_SESSION['user_id'])) {
								    ...
								    if ($user_points >= $oneGift["price"]) { ?>
                                        ...
                                        <div class="modal fade" id="exampleModal<?= $oneGift["id"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Введите адрес</h1>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Закрыть"></button>
                                                    </div>
                                                    <div class="modal-body">
